      ...
      <div class="md:w-2/3 w-full px-4 text-gray-900 flex flex-col">
        ...
        <div class="flex mt-8 flex-col md:flex-row md:justify-between">
          ...
          <div class="w-44 pt-6 md:pt-0">
            <a class="bg-gray-900 text-white justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
              Contact US
            </a>
          </div>
        </div>
        <div class="flex flex-col">
          <div class="flex my-5 flex-row justify-between">
            <a class="hidden md:block cursor-pointer text-gray-600 hover:text-gray-900 uppercase">
              About
            </a>
            <a class="hidden md:block cursor-pointer text-gray-600 hover:text-gray-900 uppercase">
              Services
