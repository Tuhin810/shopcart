      ...
      <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-6 max-w-6xl w-full">
            ...
            <form class="space-y-4">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  ...
                  onChange={(e) => setEmail(e.target.value)} type="text" required class="w-full text-sm text-gray-800 border border-gray-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Enter user name" />
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  ...
                  onChange={(e) => setPassword(e.target.value)} type="password" required class="w-full text-sm text-gray-800 border border-gray-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Enter password" />
              ...
              <div class="!mt-8">
                <button  onClick={handleSubmit} type="button" class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-lg text-white bg-gray-900 hover:bg-yellow-500 focus:outline-none">
                  Sign in
                </button>
              </div>
          ...
          <div class="max-md:mt-8">
            <img src="https://img.freepik.com/free-vector/login-concept-illustration_114360-4525.jpg?t=st=1737009942~exp=1737013542~hmac=224e2d610f2766f2dc7474f9ae097f67b8d49473bf77e9b13e7c5f843e54e35e&w=740" 
            class="w-full  mx-auto block object-cover" alt="Dining Experience" />
          </div>
        </div>
      </div>
    </div>
